...
<body>
				...
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li>
							...
							<ul>
								<li><a class="submenu" href="{{URL::to('/add-product')}}"><i class="icon-plus"></i><span class="hidden-tablet"> Add Products</span></a></li>
								<li><a class="submenu" href="{{URL::to('/all-product')}}"><i class="icon-file"></i><span class="hidden-tablet"> All Products</span></a></li>
								
							</ul>	
						</li>
						<li>
							<a class="dropmenu" href="#"><i class="icon-folder-close"></i><span class="hidden-tablet"> Slider</span></a>
							<ul>
						...
						<li>
							<a class="dropmenu" href="#"><i class="icon-folder-open"></i><span class="hidden-tablet"> User</span></a>
							<ul>
								<li><a class="submenu" href="{{URL::to('/add-user')}}"><i class="icon-align-justify"></i><span class="hidden-tablet"> Add User</span></a></li>
								<li><a class="submenu" href="{{URL::to('/manage-user')}}"><i class="icon-star"></i><span class="hidden-tablet"> All User</span></a></li>
								
							</ul>	
						</li>
						<li><a href="{{URL::to('/manage-order')}}"><i class="icon-lock"></i><span class="hidden-tablet"> Manage Order</span></a></li>
						<!-- <li><a href="{{URL::to('/manage-user')}}"><i class="icon-font"></i><span class="hidden-tablet"> Manage User</span></a></li>
						<li><a href="{{URL::to('/add-user')}}"><i class="icon-picture"></i><span class="hidden-tablet"> Add User</span></a></li> -->
	...
	<footer>
		...
		<p>
			<span style="text-align:left;float:left">&copy; 2018 <a href="http://www.facebook.com/ishakahammedzinda" alt="Bootstrap Themes">Esoft</a></span>
			<span class="hidden-phone" style="text-align:right;float:right">Powered by: <a href="http://www.facebook.com/ishakahammedzinda" alt="Bootstrap Admin Templates">Esoft</a></span>
		</p>
