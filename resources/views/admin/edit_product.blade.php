			...
			enctype="multipart/form-data">
			  ...
			  <fieldset>
                ...
                <div class="control-group">
                   ...
                   <option value="{{$v_product->category_id}}"> {{$v_product->category_name}} 	</option>	
				  ...
				  <div class="control-group">
         					<label class="control-label" for="selectError3">Manufacture Name</label>
                                ...
                                ->where('publication_status',1)
                                ->get();
                                foreach ($all_published_manufacture as $v_product) {?>
									<option value="{{$v_product->manufacture_id}}">{{$v_product->manufacture_name}}</option>
									<?php } ?>
								  </select>
								</div>
							  </div>
				...
				<div class="control-group">
				  <label class="control-label" for="date01">Product version</label>
				  <div class="controls">
					<input type="text" class="input-xlarge" name="product_version" value="{{$product_info->product_version}}">
				  </div>
				</div>
